...
const myURL = new URL('https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=313193984&start=we'); //start가 여러개 일 때는 we를 써서 두개 다 가져오는 메서드도 존재한다. 
...
console.log(myURL.searchParams.getAll('filter')); //필터로 가져온다.
